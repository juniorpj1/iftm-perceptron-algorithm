...
public class InterfacePerceptron extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       apr = new Learning();
       apr.algorithm(Double.parseDouble(jTextField1.getText()), Double.parseDouble(jTextField2.getText()));
       jTextField3.setText(""+apr.getEpochs());
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
       val = new Validation();
       jTextField4.setText(val.test(mat, apr.getWeights(), apr.getTargets(), Double.parseDouble(jTextField2.getText())));
